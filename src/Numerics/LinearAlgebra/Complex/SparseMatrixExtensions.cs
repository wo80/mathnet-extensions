...
namespace MathNet.Numerics.LinearAlgebra.Complex
{
    ...
    public static class SparseMatrixExtensions
    {
        ...
        /// </remarks>
        public static void Multiply(this SparseMatrix matrix, Vector<Complex> x, Vector<Complex> y)
        {
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void Multiply(this SparseMatrix matrix, Complex[] x, Complex[] y)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void Multiply(this SparseMatrix matrix, Complex alpha, Vector<Complex> x,
            Complex beta, Vector<Complex> y)
        {
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void Multiply(this SparseMatrix matrix, Complex alpha, Complex[] x, Complex beta, Complex[] y)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void TransposeMultiply(this SparseMatrix matrix, Vector<Complex> x, Vector<Complex> y)
        {
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void TransposeMultiply(this SparseMatrix matrix, Complex[] x, Complex[] y)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void TransposeMultiply(this SparseMatrix matrix, Complex alpha, Vector<Complex> x,
            Complex beta, Vector<Complex> y)
        {
            Multiply(matrix, alpha, x.Data(), beta, y.Data());
        }
        ...
        /// Input values of vector y will be accumulated.
        /// </remarks>
        public static void TransposeMultiply(this SparseMatrix matrix, Complex alpha, Complex[] x, Complex beta, Complex[] y)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// <summary>
        /// Compute the (conjugate) transpose of the matix.
        /// </summary>
        /// <param name="matrix">The sparse matrix.</param>
        ...
        public static void FastTranspose(this SparseMatrix matrix, SparseMatrix target)
        {
            ...
            storage = target.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            if (cx.Length < ax.Length)
            {
                ...
                storage.Values = cx = new Complex[ax.Length];
        ...
        public static void FastPermuteRows(this SparseMatrix matrix, int[] perm)
        {
            ...
            var target = temp.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// <returns></returns>
        public static Matrix<Complex> FastAdd(this SparseMatrix matrix, SparseMatrix other)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            storage = other.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            storage = result.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        {
            var storageA = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
            var storageB = other.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            var storageC = C.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            var cx = storageC.Values = new Complex[nnz];
        ...
        /// </remarks>
        public static void FastAddDiagonalScalar(this SparseMatrix matrix, Complex value)
        {
            int nrows = matrix.RowCount;
        ...
        /// to previously non-existing diagonals.
        /// </remarks>
        public static void FastAddDiagonalMatrix(this SparseMatrix matrix, Complex[] diag, SparseMatrix result)
        {
            int nrows = matrix.RowCount;
        ...
        public static void FastRowNorms(this SparseMatrix matrix, int norm, double[] result)
        {
            ...
            if (norm == 0)
            {
                for (i = 0; i < nrows; i++)
                {
                    ...
                    for (k = k1; k < k2; k++)
                    {
                        scal = Math.Max(scal, Complex.Abs(ax[k]));
                    }
        ...
        public static void FastColumnNorms(this SparseMatrix matrix, int norm, double[] result)
        {
            ...
            if (norm == 0)
            {
                for (i = 0; i < nnz; i++)
                {
                    ...
                    result[j] = Math.Max(result[j], Complex.Abs(ax[i]));
                }
            }
            else if (norm == 1)
            {
            ...
            else if (norm == 2)
            {
                for (i = 0; i < nnz; i++)
                {
                    result[ai[i]] += ax[i].MagnitudeSquared();
                }
        ...
        /// <param name="diag">Array representing the diagonal matrix.</param>
        /// <param name="result">Resulting matrix (can be the same as this instance).</param>
        public static void FastScaleRows(this SparseMatrix matrix, Complex[] diag, SparseMatrix result)
        {
        ...
        /// <param name="diag">Array representing the diagonal matrix.</param>
        /// <param name="result">Resulting matrix (can be the same as this instance).</param>
        public static void FastScaleColumns(this SparseMatrix matrix, Complex[] diag, SparseMatrix result)
        {
            int n = matrix.RowCount;
        ...
        public static void FastNormalizeRows(this SparseMatrix matrix, int norm)
        {
            ...
            FastScaleRows(matrix, zdiag, matrix);
        }
        ...
        public static void FastNormalizeColumns(this SparseMatrix matrix, int norm)
        {
            ...
            FastScaleColumns(matrix, zdiag, matrix);
        }
        ...
        public static Vector<Complex> FastGetRow(this SparseMatrix matrix, int rowIndex)
        {
            ...
            ExistingData existingData = ExistingData.Clear)
        {
            ...
            storage.GetRow(rowIndex, (Complex[])target);
        }
            ...
            SparseMatrix target)
        {
            ...
            var targetStorage = target.Storage as SparseCompressedRowMatrixStorage<Complex>;
            ...
            int[] rowIndices, SparseMatrix source)
        {
            ...
            var sourceStorage = source.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        /// <param name="matrix">The sparse matrix.</param>
        /// <returns></returns>
        public static Complex[] FastDiagonal(this SparseMatrix matrix)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
        ...
        public static int DropZeros(this SparseMatrix matrix, double tolerance = 0.0)
        {
            ...
            else
            {
                func = (i, j, aij) =>
                {
                    return (Complex.Abs(aij) > tolerance);
                };
            }
        ...
        public static int Keep(this SparseMatrix matrix, Func<int, int, Complex, bool> func)
        {
            var storage = matrix.Storage as SparseCompressedRowMatrixStorage<Complex>;
